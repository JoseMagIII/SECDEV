...
public class SQLite {
    ...
    public void addUser(String username, String password, String securityQuestion) {
        String sql = "INSERT INTO users(username,password,securityQuestion) VALUES('" + username + "','" + password + "','" + securityQuestion + "')";
...
//      pstmt.executeUpdate();
    ...
    public ArrayList<User> getUsers(){
        String sql = "SELECT id, username, password, role, securityQuestion, locked FROM users";
    ...
    public void setRole(String name, char role) {
        
        String sql = "UPDATE users SET role='"  + role + "' WHERE username='" + name + "';";
    ...
    public void setLocked(String name, char role) {
        
        String sql = "UPDATE users SET locked='"  + role + "' WHERE username='" + name + "';";

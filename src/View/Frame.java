...
public class Frame extends javax.swing.JFrame {
    ...
    public void mainNav(User thatUser){
        thisUser = thatUser;
        
        switch(thisUser.getRole()){
            case 1: frameView.show(Container, "loginPnl");
            break;
            
            case 2: adminBtn.setVisible(false);
                    clientBtn.setVisible(true);
                    managerBtn.setVisible(false);
                    staffBtn.setVisible(false);
                    
                    clientHomePnl.init(main.sqlite, thisUser);
                    Content.add(clientHomePnl, "clientHomePnl");
                    clientHomePnl.showPnl("home");
                    contentView.show(Content, "clientHomePnl");
            break;
        ...
        String alertMessage = "Welcome " + thisUser.getUsername();
    ...
    public void forgotPassNav(User thatUser){
        forgotPassPnl.initUser(thatUser);
